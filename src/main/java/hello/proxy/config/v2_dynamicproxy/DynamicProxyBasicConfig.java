        ...
        OrderServiceV1 proxy =
                (OrderServiceV1)
                        Proxy.newProxyInstance(OrderServiceV1.class.getClassLoader(),
                                ...
                                new LogTraceBasicHandler(new OrderServiceV1Impl(orderRepositoryV1(logTrace)), logTrace));
        ...
        OrderControllerV1 proxy =
                (OrderControllerV1)
                        Proxy.newProxyInstance(OrderControllerV1.class.getClassLoader(),
                                ...
                                new LogTraceBasicHandler(new OrderControllerV1Impl(orderServiceV1(logTrace)), logTrace));
